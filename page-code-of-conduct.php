		...
		<div class="container">
			<div>
				<p>
					...
					providing
					exercise and recreation for members of the community. Players who join the league agree to abide by
					the
			...
			<section>
				...
				<ol>
					<li>
						Team captains will review the code of conduct with their team prior to the first game. Team
						captains
						will only field players who accept and abide by the rulings of the league. Amendments to the
						code of
					...
					<li>
						Players who cannot abide by the rulings of the league may be suspended or removed from the
						league.
					</li>
					<li>
						Players shall conduct themselves in an appropriate manner at all times. Complaints about
						behaviour
						will be directed to their team captain whom in turn informs the game official and/or the league
						executive as needed.
					</li>
					<li>
						Players shall refrain from arguing with other players, fans or the referee at all times. The
						referee
						shall be responsible for conduct of players on the field and will be treated respectfully at all
						times.
					</li>
					<li>
						Only team captains or their designate will approach the referee during the game. Players should
						not
					...
					<li>
						...
						during any and all league functions, which include but are not limited to: Annual general
						meeting,
					...
					<li>
						You must leave the field immediately upon game completion as there are only a few minutes until
						the
						next match begins. Conduct the end-game cheer and handshakes off the field so that the next
						teams
						can enter the pitch.
					</li>
					<li>
						Aggressive players will not be tolerated in this league. Players who can keep the game clean and
						are
						focused upon sharing their skills with other players in a safe manner are welcome. The focus is
						to
			...
			<section>
				...
				<ol>
					<li>
						Make every effort to develop their own sporting ability, in terms of skill, technique, tactics
						and
						stamina.
					</li>
					<li>
						Give maximum effort and strive for the best possible performance during a game, even if the team
						is
			...
			<section>
				...
				<ol>
					...
					<li>
						Resist any influence that might, or might be seen to bring into question the commitment to the
						team
						winning.
					</li>
				</ol>
			...
			<section>
				...
				<p>
					...
					realize and respect their responsibilities and duties to The Association and the game. The
					Association
					endorses The Canadian Soccer Association’s “Code of Ethics” for Referees.
					Specifically Referees shall:
				</p>
				<ul>
					<li>Conduct themselves with dignity both on and off the field of play and shall, by example,
						endeavor to inspire the true principles of fair play and earn the respect of those whom they
						serve;</li>
					<li>Not cause The Association to become involved in any controversial matters and shall abide by the
						rules and regulations of the jurisdiction in which they officiate;</li>
					...
					<li>Study the Laws of the game and be aware of all changes, and shall enforce all said Laws and
						changes;</li>
					<li>Perform their designated responsibilities, including attending organized clinics and lectures,
						etc., and shall assist their colleagues in upgrading and improving their standards of
						officiating, instructing and assessing;</li>
					<li>Honour any appointments made for and accepted by them unless unable to do so by virtue of
						illness or personal emergency;</li>
					<li>Not publicly criticize other referees or any soccer association nor shall they make any
						statements to the media related to any game in which they were involved;</li>
