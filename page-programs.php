		...
		<div class="program-content">
			...
			<div class="row">
				<p>
					...
					programs running through the week, Mens, Womens,and Masters teams in EDSA, VMSL, SAMMRL, and SASA.
					Launching Youth club & Community in 2023 fall. Always adding more and pushing the norm. Read more
					about them below.
				</p>
			</div>
		</div>
